  ...
  return (
    <QueryClientProvider client={queryClient}>
      ...
      <Stack screenOptions={{ headerShown: false }}>
        ...
        <Stack.Screen name="calendar" options={{ headerShown: true, title: 'Islamischer Kalender', animation: 'slide_from_right', headerStyle: { backgroundColor: theme === 'dark' ? '#0A1628' : '#F8F6F0' }, headerTintColor: theme === 'dark' ? '#E8E0D4' : '#1A1A2E' }} />
      </Stack>
    </QueryClientProvider>
  );
}
